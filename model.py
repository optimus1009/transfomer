...
class Transformer:
    ...
    def encode(self, xs, training=True):
        ...
        with tf.variable_scope("encoder", reuse=tf.AUTO_REUSE):
            ...
            enc *= self.hp.d_model**0.5 # scale  论文 section 3.4
            # positional Encoding
    ...
    def eval(self, xs, ys):
        ...
        for _ in tqdm(range(self.hp.maxlen2)): # hp.maxlen2: target 最大长度
        ...
        n = tf.random_uniform((), 0, tf.shape(y_hat)[0]-1, tf.int32) # 随机取一条样本，最大值为batch_size
        sent1 = sents1[n]
